        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="font-black tabular-nums leading-none max-w-full text-[clamp(4rem,10vw,12rem)] bg-gradient-to-br from-amber-200 via-amber-warm to-ember bg-clip-text text-transparent"
              style={{
